...
public class AppEspPostAtencionLineamientosDAO {
	private Connection cnn = null;
    private ResultSet rs = null;
    private static AppEspPostAtencionLineamientosDAO instancia;

    public static AppEspPostAtencionLineamientosDAO getInstancia() {
        if (instancia == null) {
            instancia = new AppEspPostAtencionLineamientosDAO();
        }
        return instancia;
    }
    
    public AppEspPostAtencionLineamientos obtenerPostAtencionLineamientosPorAplicacion(AppEspPostAtencionLineamientos info) throws Exception {
    	AppEspPostAtencionLineamientos objeto = new AppEspPostAtencionLineamientos();
        try {
            cnn = Conexion.getConexion();
            CallableStatement cs = null;
            cs= cnn.prepareCall("call sp_obtener_post_atencion_lineamientos_por_aplicacion(?,?)");
            ...
            while (rs.next()) {
            	...
            	objeto.setIdControlCambiosProcedimientosInfraestructura(rs.getInt("ID_CONTROL_CAMBIOS_PROCEDIMIENTOS_SW"));
