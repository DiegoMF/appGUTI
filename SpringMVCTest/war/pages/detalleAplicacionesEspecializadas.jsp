...
<body>
						...
						<td>
							<fieldset>
								...
								<table>
									...
									<tr>
										<td>¿Cuántos usuarios utilizan la aplicación en total?.:</td>
							...
							<fieldset>
								...
								<table border="1" width="100%" class="tablaGrilla">
									...
									<tr>
														...
														<tr>
															<td>2</td>
															<td>Herramienta de Programación</th>
			...
			<div class="formulario">
				...
				<table style="width: 100%" class="tablaDatos">
					...
					<tr>
						...
						<div>
							<fieldset>
								<legend align="left">Post Atención - Niveles de Cumplimiento</legend>
								<table>
								<tr>
								<td>&nbsp;</td>
								<td colspan="8">
	...
	<div id="divEliminaUser" style="display: none;" title="Confirmación">
		¿Estás seguro de eliminar el Evento?</div>
