...
<script>
	function ListarColumna(combo) {
		var idConsulta_Seccion = combo.val();
		var url = "/Consulta/BuscarColumna";
				...
				<tr>
					...
					<td>
						<fieldset>
							...
							<table  >
								<tr>
									<td ><select id="pantallas" name="D3" onchange="ListarColumna($(this)); return false;">
											<option value="">Seleccione</option>
											<c:forEach var="listValue" items="${ListaConsulta_Seccion}">
												<option value="${listValue.idConsulta_Seccion}">${listValue.descripcion}</option>
											</c:forEach>
