...
<script>
	$().ready(
			function() {
				...
				$('#estado > option[value="${listaReporte.estado}"]').attr(
						'selected', 'selected');
...
<div class="formulario">
	<form action="<c:url value="/Reporte/grabarReporte" />" method="post"
		id="formulario">
		...
		<div>
			<table class="tablaDatos">
				<tr>
					...
					<td><input type="text" name="nombreReporte" id="nombreReporte"
						style="width: 400px;" value="${listaReporte.nombreReporte}"
					...
					<td><input type="text" style="width: 100px;"
						...
						value="${listaReporte.fechaCreacion}" class="tcal" required></td>
				...
				<tr>
					<td>
						<fieldset>
							...
							<table>
								<tr>
									<td><select id="cboSeccion" name="cboSeccion"
										onchange="ListarFiltro();">
								...
								<tr>
									<td style="min-width: 300px;">
										<div id="divListaFiltro">
											<select name="fOrigen" id="fOrigen" multiple="multiple"
												class="filtro" style="min-width: 300px; min-height: 400px;"></select>
										</div>
									</td>
									<td>
										<div class="diver">
											<input type="button" class="agregar izq"
												value="&raquo;&raquo;"><br> <input
												type="button" class="quitar der" value="&laquo;&laquo;">
										</div>
									</td>
									<td style="min-width: 300px;">
		...
		<div>
			...
			<table class="tablaBotones">
				<tr>
					<td align="right"><input type="submit" name="grabar"
						value="Grabar"></input> <input type="submit" name="regresar"
						value="Regresar"></input></td>
				</tr>
			</table>
